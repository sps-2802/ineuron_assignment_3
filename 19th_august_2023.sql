...
create table city(id integer,name varchar(17),country_code varchar(3),district varchar(20),population int);

-- inserting values into city table
insert into city values ('6','Rotterdam','NLD','Zuid-Holland','1235633');
...
select * from city where country_code = 'JPN';
-----------------------------------------------------------------------------------
-- creation of table station
create table station(id integer,city varchar(21),state varchar(2),Lat_n integer,Long_W integer);
...
insert into station values( '566','MarineOnSaintCroix','MN','128','126');
...
select count(city) as total_number_of_cities,
       count(distinct(city)) as distinct_city_entries,
...
SELECT CITY, LENGTH(CITY) AS Number_of_characters_in_city 
FROM STATION
WHERE LENGTH(CITY) = (SELECT MIN(LENGTH(CITY)) FROM STATION)
   OR LENGTH(CITY) = (SELECT MAX(LENGTH(CITY)) FROM STATION)
ORDER BY Number_of_characters_in_city, CITY ;
...
create table product(product_id int,product_name varchar(30),unit_price int);
...
select p.product_id,p.product_name from sales s left join product p on s.product_id = p.product_id where s.sale_date BETWEEN '2019-01-01' AND '2019-03-31';
...
insert into views(article_id ,author_id ,viewer_id , view_date) values(1,3,5,'2019-08-01'),(1,3,6,'2019-08-02'),(2,7,7,'2019-08-01'),
(2,7,6,'2019-08-02'),(4,7,1,'2019-07-22'),(3,4,4,'2019-07-2d  1'),(3,4,4,'2019-07-21');
...
(2,5,'2019-08-02','2019-08-02'),(3,1,'2019-08-11','2019-08-11'),(4,3,'2019-08-24','2019-08-26'),
...
as immediate from delivery;

-- Q20. Write an SQL query to find the ctr of each Ad. Round ctr to two decimal points. Return the result table ordered by ctr
-- in descending order and by ad_id in ascending order in case of a tie
...
insert into employee(employee_id,team_id) values(1,8),(2,8),(3,8),(4,7),(5,9),(6,9);
select * from employee;
select employee_id,(select count(employee_id) from employee e2 where e1.team_id = e2.team_id) as team_size from employee e1;
select employee_id,
...
(2,'2019-02-01','2019-02-20',15),(2,'2019-02-01','2019-02-20',30);
insert into unitssold (product_id,purchase_date,units) values(1,'2019-02-25',100),(1,'2019-03-01',15),(2,'2019-02-10',200),
(2,'2019-03-22',30);

select p.product_id, round(sum(u.units*p.price)/sum(u.units),2)as average_price from prices p join unitssold u on p.product_id = u.product_id and u.purchase_date 
...
create table products(product_id int,product_name varchar(30),product_category varchar(30));
create table orders(product_id int,order_date date, unit int);

alter table orders add constraint fk foreign key(product_id) references products(product_id);
alter table products add constraint pk primary key (product_id);

insert into products(product_id,product_name,product_category) values (1,'Leetcode solutions','Book'),
(2,'Jewels of stringology','book'),(3,'HP','Laptop'),(4,'Lenovo','Laptop'),(5,'LeetcodeKit','Tshirt');
insert into orders (product_id,order_date,unit) values (1,'2020-02-05',60),(1,'2020-02-10',70),(2,'2020-01-18',30),
(2,'2020-02-11',80),(3,'2020-02-17',2),(3,'2020-02-24',3),(4,'2020-03-01',20),(4,'2020-03-04',30), (4,'2020-03-04',60),(5,'2020-02-25',50),(5,'2020-02-27',50),(5,'2020-03-01',50);

select p.product_name,sum(o.unit) as unit from products p join orders o on p.product_id = o.product_id  where 
o.order_date between '2020-02-01' and '2020-02-29' group by p.product_name having sum(o.unit)>=100 ;

-- 27. Write an SQL query to find the users who have valid emails. A valid e-mail has a prefix name and a domain where: ●The prefix name is a string that may contain letters (upper or lower case), digits, underscore '_', period '.', and/or dash '-'. The prefix name must start with a letter. ●The domain is '@leetcode.com'.
create table users (user_id int,name varchar,mail varchar);

insert into users (user_id,name,mail) values (1,'winston','winston@leetcode.com'),(2,'Jonathan','jonathanisgreat'),(3,'Annabelle','bella-@leetcode.com'),(4,'Sally','sally.come@leetcode.com'),(5,'Marwan','quarz#2020@leetcode.com'),
...
-- 28.Write an SQL query to report the customer_id and customer_name of customers who have spent atleast $100 in each month of June and July 2020
create table customers(customer_id int,name varchar, country varchar);
create table product(customer_id int, name varchar,country varchar);
create table Orders(order_id int,customer_id int,product_id int,order_date date,quantity int);

alter table orders add primary key(order_id);
alter table customers add primary key(customer_id);
alter table product add primary key(customer_id);

insert into customers(customer_id,name,country) values(1,'winston','USA'),(2,'Jonathan','Peru'),(3,'Moustafa','Egypt');
insert into product(customer_id,name,country) values(10,'LC Phone',300),(20,'LC T-shirt',10),(30,'LC Book',45),(40,'LC Keychain',2);
insert into orders(order_id,customer_id,product_id,order_date,quantity) values (1,1,10,'2020-06-10',1),(2,1,20,'2020-07-01',1),
(3,1,30,'2020-07-08',2),(4,2,10,'2020-06-15',2),(5,2,40,'2020-07-01',10),(6,3,20,'2020-06-24',2),(7,3,30,'2020-06-25',2),(9,3,30,'2020-05-08',3);
...
create table tvprogram (program_date date, content_id int, channel varchar);
create table content(content_id varchar,title varchar,kids_content varchar(1),content_type varchar);

insert into tvprogram(program_date,content_id,channel)values('2020-06-10 08:00',1,'LC-Channel'),('2020-05-11 12:00',2,'LC-Channel'),('2020-05-12 12:00',3,'LC-Channel'),('2020-05-13 14:00', 4,'Disney Ch'),('2020-06-18 14:00',4,'Disney Ch'),('2020-07-15 16:00',5,'Disney Ch');
insert into content(content_id,title,kids_content,content_type) values (1,'Leetcode Movie','N','Movies'),(2,'Alg.for Kids','Y','series'),(3,'Database Sols','N','series'),(4,'Aladdin','Y','Movies'),(5,'Cinderella','Y','Movies');

select distinct(c.title) from content c join tvprogram t on t.content_id = c.content_id where c.kids_content ='Y' and c.content_type = 'Movies' and month(t.program_date) = 6; 
...
insert into npv(id,year,npv)values(7,2020,30),(13,2019,40),(1,2019,113),(2,2008,121),(3,2009,12),(11,2020,99),(7,2019,0);
insert into queries(id,year)values(1,2019),(2,2008),(3,2009),(7,2018),(7,2019),(7,2020),(13,2019);

select q.id,q.year,coalesce(n.npv,0) as npv from queries q left join npv n on q.id = n.id and q.year=n.year order by q.id asc 
...
insert into employees(id,name)values(1,'Alice'),(7,'Bob'),(11,'Meir'),(90,'Winston'),(3,'Jonathan');
insert into EmployeeUNI(id,unique_id)values(3,1),(11,2),(90,3);

select coalesce(eu.unique_id,null),e.name from EmployeeUNI eu right join employees e 
on e.id = eu.id;
...
insert into users(id,name)values(1,'Alice'),(2,'Bob'),(3,'Alex'),(4,'Donald'),(7,'Lee'),(13,'Jonathan'),(19,'Elvis');
insert into rides(id,user_id,distance)values(1,1,120),(2,2,317),(3,3,222),(4,7,100),(5,13,312),(6,19,50),(7,7,120),(8,19,400),(9,7,230);

alter table users add primary key(id);
alter table rides add primary key(id);

select u.name, coalesce(sum(r.distance),0) as travelled_distance from users u left join rides r on u.id = r.user_id  group by u.name order by sum(r.distance) desc,u.name asc; 
...
insert into movies(movie_id,title) values (1,'Avengers'),(2,'Frozen 2'),(3,'Joker');
insert into users(user_id,name)values(1,'Daniel'),(2,'Monica'),(3,'Maria'),(4,'James');
insert into MOVIERATING (movie_id,user_id,rating,created_at) values(1,1,3,'2020-01-12'),(1,2,4,'2020-02-11'),(1,3,2,'2020-02-12'),(1,4,1,'2020-01-01'),(2,1,5,'2020-02-17'),(2,2,2,'2020-02-01'),(2,3,2,'2020-03-01'),(3,1,3,'2020-02-22'),(3,2,4,'2020-02-25');

select case when distinct(count(user_id)) >max(count(user_id)) then user_id  
...
create table students(id int,name varchar,department_id int);

alter table departments add primary key(id);
alter table students add primary key(id);

insert into departments(id,name) values (1,'Electrical Engineering'),(7,'Computing Engineering'),(13,'Business Administration');

insert into students(id,name,department_id) values(23,'Alice',1),(1,'Bob',7),(5,'Jennifer',13),(2,'john',14),(4,'Jasmine',77),(3,'steve',74),(6,'Luis',1),(8,'Jonathan',7),(7,'Daiana',33),(11,'Madelynn',1);
...
insert into calls (from_id,to_id,duration) values(1,2,59),(2,1,11),(1,3,20),(3,4,100),(3,4,200),(3,4,200),(4,3,499);
...
insert into prices(product_id,start_date,end_date,price) values (1,'2019-02-17','2019-02-28',5),(1,'2019-03-01','2019-03-22',20),
(2,'2019-02-01','2019-02-20',15),(2,'2019-02-01','2019-02-20',30);
insert into unitssold (product_id,purchase_date,units) values(1,'2019-02-25',100),(1,'2019-03-01',15),(2,'2019-02-10',200),(2,'2019-03-22',30);
...
create table Warehouse (name varchar,product_id int,units int);
create table Products(product_id int,product_name varchar,width int,length int,height int);

alter table Warehouse add primary key(name,product_id);
alter table Products add primary key(product_id);

insert into Warehouse (name,product_id,units) values('LCHouse1',1,1),('LCHouse1',2,10),('LCHouse1',3,5),('LCHouse2',1,2),('LCHouse2',2,2),('LCHouse3',4,1);
insert into Products(product_id ,product_name ,width ,length ,height )values(1,'LC-TV',5,50,40),(2,'LC-KeyChain',5,5,5),(3,'LC-Phone',2,10,10),(4,'LC-T-Shirt',4,10,20);
...
Create table Sales(sale_date date,fruit varchar,sold_num int);

alter table Sales add primary key(sale_date,fruit);

insert into Sales(sale_date,fruit,sold_num)values('2020-05-01','apples',10),('2020-05-01','oranges',8),('2020-05-02','apples',15),('2020-05-02','oranges',15),('2020-05-03','apples',20),('2020-05-03','oranges',0),('2020-05-04','apples',15),('2020-05-04','oranges',16);
...
insert into Activity (player_id ,device_id ,event_date ,games_played )values(1,2,'2016-03-01',5),(1,2,'2016-03-02',6),(2,3,'2017-06-25',1),(3,1,'2016-03-02',0),(3,4,'2018-07-03',5);
...
create table Employee(id int,name varchar,department varchar,managerId int);

alter table Employee add primary key(id);

insert into Employee(id ,name ,department ,managerId )values(101,'John','A',NULL),(102,'Dan','A',101),(103,'James','A',101),(104,'Amy','A',101),(105,'Anne','A',101),(106,'Ron','B',101);

select distinct(e1.name) from employee e1 join employee e2 on e1.id =e2.managerid group by e1.name having count(e1.id)>4; 
...
create table Student (student_id int,student_name varchar,gender varchar,dept_id int);
create table Department (dept_id int,dept_name varchar);

alter table Student add primary key(student_id);
alter table Student add constraint fk foreign key(dept_id) references Department(dept_id);
alter table Department add primary key(dept_id);

insert into Student(student_id ,student_name ,gender ,dept_id)values (1,'Jack','M',1),(2,'Jane','F',1),(3,'Mark','M',2);
insert into department(dept_id,dept_name)values(1,'Engineering'),(2,'Science'),(3,'Law');

select d.dept_name,
count(s.dept_id) as student_number from department d left join student s on s.dept_id = d.dept_id  group by d.dept_name order by student_number desc,d.dept_name; 
...
alter table customer add constraint fk foreign key(product_key) references Product(product_key);
alter table Product add primary key(product_key);

insert into Customer (customer_id,product_key)values(1,5),(2,6),(3,5),(3,6),(1,6);
insert into Product(product_key)values(6),(6);

select distinct(c.customer_id) from customer c left join product p where p.product_key=c.product_key group by c.customer_id HAVING COUNT(DISTINCT p.product_key) = (SELECT COUNT(DISTINCT product_key) FROM Product);
...
create table Employee(employee_id int,name varchar,experience_years int);

alter table Project add primary key(project_id ,employee_id);
alter table Project add constraint fk foreign key(employee_id) references employee(employee_id);
alter table employee add primary key(employee_id);

insert into  Project(project_id ,employee_id )values(1,1),(1,2),(1,3),(2,1),(2,4);
insert into employee(employee_id,name,experience_years)values(1,'Khaled',3),(2,'Ali',2),(3,'John',3),(4,'Doe',2);
...
create table books(book_id int,name varchar,available_from date);
create table orders(order_id int,book_id int,quantity int,dispatch_date date);

alter table books add primary key(book_id);
alter table orders add primary key(order_id);
alter table orders add constraint fk foreign key(book_id) references books(book_id);

insert into books(book_id,name,available_from)values(1,'Kalila And Demna','2010-01-01'),(2,'28 Letters','2012-05-12'),(3,'The Hobbit','2019-06-10'),(4,'13 Reasons Why','2019-06-01'),(5,'The Hunger Games','2008-09-21');
...
50.The winner in each group is the player who scored the maximum total points within the group. In the case of a tie, the lowest player_id wins. Write an SQL query to find the winner in each group.
...
alter table teams rename column team_name to group_id;
